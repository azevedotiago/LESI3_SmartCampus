...
You can check out the official install guide: https://github.com/esp8266/Arduino/blob/master/doc/installing.md
*/
...
void setup(void){
  ...
  wifiMulti.addAP("smartenergy", "20222023lesi");   // add Wi-Fi networks you want to connect to
